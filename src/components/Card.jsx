...
const Card = ({ name, developers, releaseDate, rating, cover, id }) => {
    return (
        <div className='flex flex-col justify-between h-auto duration-300 border rounded-lg shadow max-h-[542px] w-80 bg-slate-300 bg-opacity-20 border-slate-100 hover:translate-y-3'>
